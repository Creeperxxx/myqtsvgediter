...
//	params->m_center = diaitem->getselfdrawcenter();
//	//params->m_painter = painter;
//	params->m_spacesize = diaitem->getselfdrawspacesize();
...
//		break;
//	case ShapeType::Line:
//		return std::make_unique<buildtuxingjiedianparamsfordiagramline>();
//		break;
//	default:
//		throw std::runtime_error("error");
//		break;
...
//		break;
//	case ShapeType::Line:
//		return std::make_unique<buildDiagramPixmapParamsLine>();
//		break;
//	default:
//		throw std::runtime_error("error");
//	}
